...
- **Citations** — keep each claim's inline \`[(<source-slug> p. N)](../sources/<source-slug>.md)\` verbatim, page number included; never drop it to read more smoothly, not even in a clean summary.
