...
- **Citations** — keep each claim's inline citation \`[(Source Name, p. N)](../sources/<slug>.md)\` exactly as written, page number included; never drop it to read more smoothly, not even in a clean summary.
