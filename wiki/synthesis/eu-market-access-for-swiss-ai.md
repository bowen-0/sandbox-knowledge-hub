...
The [[inspection-robots]] project — built around [[anybotics]] and [[modulos]] — was the explicit Phase II vehicle for working out this new regulatory geometry [(00-overview-phase2-build-and-share p. 14)](../sources/00-overview-phase2-build-and-share.md).
...
In translation: for the first time, the sandbox project also worked across borders with the competent supervisory authorities, the Federal Network Agency in Germany ([[bundesnetzagentur-de]]) and the Office for Digital Innovation of the Principality of Liechtenstein ([[li-digital-innovation]]).
...
> |---|---|
> | **Project-level engagement** | Structured 9–12 month engagement with sandbox programme + [[itsl-uzh]] legal analysis; most Phase II use cases completed within 9 to 12 months [(00-overview-phase2-build-and-share p. 8)](../sources/00-overview-phase2-build-and-share.md). |
> | **Convening with EU authorities** | The [[inspection-robots]] precedent — cross-border collab with [[bundesnetzagentur-de]] / [[li-digital-innovation]] [(00-overview-phase2-build-and-share p. 14)](../sources/00-overview-phase2-build-and-share.md). |
> | **ISO/IEC 42001 piloting** | [[modulos]]-style operationalisation of AI-management standards [(00-overview-phase2-build-and-share p. 14)](../sources/00-overview-phase2-build-and-share.md). |
...
> - If you need rapid certification (next 3 months), the sandbox cadence is wrong — projects run 9–12 months [(00-overview-phase2-build-and-share p. 8)](../sources/00-overview-phase2-build-and-share.md).
