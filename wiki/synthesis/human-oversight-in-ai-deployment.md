...
- **Autonomous systems & the EU AI Act.** For any high-risk system, human oversight is a standing [[eu-ai-act|EU AI Act]] obligation alongside risk management, transparency and accuracy — the recurring safeguard cluster the Act imposes, and the one [[medical-device-regulation|medical AI]] inherits when the Act stacks on top of the medical-device regime.
