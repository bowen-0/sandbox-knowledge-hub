...
- **[[building-permits]]** — the prototype uses *pure rule-based logic* for procedure determination (8 project types × ~20 zone/protection criteria → if/then matrix); the report states the team deliberately uses no generative AI for this clearly structured decision process, only a simple if/then logic [(Building Permits report, p. 20)](../sources/p2-building-permits.md), and prints the full decision matrix [(Building Permits report, p. 17)](../sources/p2-building-permits.md). Generative AI is reserved for unstructured document quality checks (e.g. solar-datasheet against "low reflectivity" criteria) [(Building Permits report, p. 21)](../sources/p2-building-permits.md). Quantitative support: best LLM accuracy on perfect answers is 60.2%; average 37.9% [(Building Permits report, p. 14)](../sources/p2-building-permits.md). For administrative decisions, that's insufficient — and probabilistic AI fights the administrative-reproducibility requirement (95% vs 99% reliability is a *substantive political* question) [(Building Permits report, p. 22)](../sources/p2-building-permits.md).
- **[[bridge-monitoring]]** — data-driven approaches complement standards-based engineering; they do not replace deterministic structural-engineering logic [(Bridge Monitoring report, p. 6)](../sources/p2-bridge-monitoring.md).
- **[[inspection-robots]]** — deterministic safety logic vs. self-evolving ML is named as the operative tension under the EU Machinery Regulation [(Inspection Robots report, p. 9)](../sources/p2-inspection-robots.md).
