...
- **Analysis**: IBM Research merged the imagery with a custom multi-stage stitching algorithm and applied a vision-transformer foundation model (trained first on general images, then on civil-infrastructure images, then refined for crack detection); results were presented in IBM's One-Click-Learning (OCL) platform [(p1-infrastructure-maintenance p. 10)](../sources/p1-infrastructure-maintenance.md).
...
- [[raphael-von-thiessen]]: project conception and coordination, Head of Innovation Sandbox for AI, Canton of Zurich [(p1-infrastructure-maintenance p. 28)](../sources/p1-infrastructure-maintenance.md).
